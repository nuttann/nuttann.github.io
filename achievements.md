...
- Empires of Kunark
  ...
  - Collections
    ...
    - Brutal Accoaldes (Chardok)
      ...
      - Taskmaster's Accolade (Gallin)
      - Stalker's Accolade (Gallin)
      - Oppressor's Accolade (Gallin)
      - Slayer's Accolade (Nanbus)
      - Chardok Butcher's Badgs (Gallin, Nanbus)
    - Torturer's Tools (Chardok)
      - Disciplining Flesh-barb (Nanbus)
      - Despot's Brandisher (Gallin, Nanbus)
      - Master's Mercy (Gallin, Nanbus)
      - Gradual Interrogator (Gallin, Nanbus)
